...
class TripleCrossTrader(TradingBinance):
    
    
    def __init__(self, self, symbol, bar_length, units, stop_stream, position = 0, sma_s, sma_m, sma_l):
    ...
    def define_strategy(self):
        ...
        data["SMA_M"] = Indicator(data.Close).SMA(self.sma_m)
...
if __name__ == "__main__":
    ...
    sma_m = 50 # change it according to your analysis
    sma_l = 800 # change it according to your analysis
    units = units
    position = 0
    
    trader = TripleCrossTrader(symbol = symbol, 
